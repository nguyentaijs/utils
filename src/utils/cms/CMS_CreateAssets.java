...
public class CMS_CreateAssets {
	...
	public static void run() throws IOException {
		...
		String path = ConsoleIO.nextLine("Input Path", StringUtils.EMPTY, scanner);
		...
		do {
			...
			fileNameStr = ConsoleIO.nextLine("Input file name", "Leave empty = end", scanner);
